...
class DataManager {
    ...
    let title = ["Развлечения", "Кулинария", "Образование", "Для компании", "Мой список"]
    ...
    let recreational = [
        ...
        "Сходи на прогулку",
        "Прими ванну с пеной",
        "Пригласите друзей на вечер игр",
        ...
        "Потратьте свое время на просмотр этого приложения и в конечном итоге ничего не сделайте",
    ...
    let cooking = [
        ...
        "Составьте план питания на ближайшую неделю",
        "Научись печь хлеб",
        "Сделай мороженое",
        "Испеки торт",
        "Сделай бутерброд",
